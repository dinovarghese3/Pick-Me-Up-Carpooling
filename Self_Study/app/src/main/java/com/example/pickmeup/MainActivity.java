...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting different layer ids

        // Mapbox access token is configured here. This needs to be called either in your application
        // object or in the same activity which contains the mapview.
        Mapbox.getInstance(this, "pk.eyJ1IjoiZGlub3ZhcmdoZXNlMyIsImEiOiJjazUzcHl2bTMwYjllM25waGkzZDhpYmYwIn0.A3nerTuymX-HDgg90a5xMA");
...
// Make a toast which displays the route's distance
                Toast.makeText(MainActivity.this,currentRoute.distance().toString(), Toast.LENGTH_SHORT).show();
